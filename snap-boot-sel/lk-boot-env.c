...
void print_usage() {
    printf("usage:\n"
           ...
           "\t\t[-g, --boot-0-part=<part name>]\n"
           "\t\t[-i, --boot-1-part=<part name>]\n"
...
void print_environment(const SNAP_BOOT_SELECTION_t *bootSel) {
    ...
    printf("bootimg_file_name [%s]\n", bootSel->bootimg_file_name);
}
...
int main (int argc, char **argv) {
    ...
    while ((opt = getopt_long(argc, argv, "w:r:u:ha:b:c:d:e:f:g:i:j:k:l:",
